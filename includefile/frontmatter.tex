...
\zihao{4}
\begin{tabular}{ r l }
 \zihao{4}Candidate:      &  {\the\Eauthor}      \\
\zihao{4}Student Number: & {\the\StudentNumber} \\
 \zihao{4}Supervisor:     &  {\the\Esupervisor}   \\
\zihao{4}Major:          & \the\Emajor  \\
\ifsmd \else \zihao{4}Speciality:     & \the\Especiality \fi
\end{tabular}
...
\newpage
\vspace*{20pt}
\begin{center}{\heiti\zihao{-2} 论文原创性声明}\end{center}
\par\vspace*{30pt}
...
\thispagestyle{empty}%崔立豪，20210317
\vskip2cm
